...
namespace ResponsiveGridSystem
{
    ...
    /// Class Row.
    /// </summary>
    /// <seealso cref="ResponsiveGridSystem.WrapPanel" />
    ...
    public class Row : WrapPanel
    {
        ...
        /// <exception cref="System.ArgumentOutOfRangeException">MaxColumns</exception>
        ...
        public static readonly DependencyProperty ColumnHeightInMobileProperty = DependencyProperty.Register(
            "ColumnHeightInMobile", typeof(double), typeof(Row), new PropertyMetadata(double.NaN));
        ...
        public static readonly DependencyProperty ColumnHeightInTabletProperty = DependencyProperty.Register(
            "ColumnHeightInTablet", typeof(double), typeof(Row), new PropertyMetadata(double.NaN));
        ...
        public static readonly DependencyProperty ColumnHeightInDesktopProperty = DependencyProperty.Register(
            "ColumnHeightInDesktop", typeof(double), typeof(Row), new PropertyMetadata(double.NaN));
        ...
        public static readonly DependencyProperty ColumnHeightInHubProperty = DependencyProperty.Register(
            "ColumnHeightInHub", typeof(double), typeof(Row), new PropertyMetadata(double.NaN));
        ...
        private void OnSizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            foreach (var column in columns)
            {
                ...
                var columnHeightInMobile = column.ForceHeightInMobile > 0 
                    ? column.ForceHeightInMobile
                    : ColumnHeightInMobile > 0 ? ColumnHeightInMobile : 0;

                var columnHeightInTablet = column.ForceHeightInTablet > 0 
                    ? column.ForceHeightInTablet
                    : ColumnHeightInTablet > 0 ? ColumnHeightInTablet : columnHeightInMobile;

                var columnHeightInDesktop = column.ForceHeightInDesktop > 0 
                    ? column.ForceHeightInDesktop 
                    : ColumnHeightInDesktop > 0 ? ColumnHeightInDesktop : columnHeightInTablet;

                var columnHeightInHub = column.ForceHeightInHub > 0 
                    ? column.ForceHeightInHub 
                    : ColumnHeightInHub > 0 ? ColumnHeightInHub : columnHeightInDesktop;
                    ...
                    case DeviceTypes.Mobile:
                        {
                            ...
                            currentColumnHeight = columnHeightInMobile;
                    ...
                    case DeviceTypes.Tablet:
                        {
                            ...
                            currentColumnHeight = columnHeightInTablet;
                    ...
                    case DeviceTypes.Desktop:
                        {
                            ...
                            currentColumnHeight = columnHeightInDesktop;
                    ...
                    case DeviceTypes.Hub:
                        {
                            ...
                            currentColumnHeight = columnHeightInHub;
                ...
                column.Height = currentColumnHeight;
        ...
        private double CalculateCurrentWidth(double controlWidth, double columns)
        {
            var width = controlWidth*columns/Convert.ToDouble(MaxColumns) - (ColumnSpace.Left + ColumnSpace.Right + 0.5);
